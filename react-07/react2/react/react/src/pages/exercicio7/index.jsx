...
export default function Exercicio7() {
    ...
    // Filtrar usuários usando operação OU - qualquer filtro ativo pode ser verdadeiro
    const usuariosFiltrados = usuarios.filter(usuario => {
        ...
        const nenhumFiltroAtivo = (
            ...
            !filtroDataInicio && 
            !filtroDataFim && 
            filtroStatus.mostrarAtivos && 
            filtroStatus.mostrarInativos && 
        ...
        // Array para armazenar os resultados de cada filtro
        ...
        if (filtro) {
            ...
            resultadosFiltros.push(nomeOuEmailMatch);
        }
        ...
        // Filtro por status (ativo/inativo) - apenas se não estiver mostrando ambos
        if (!filtroStatus.mostrarAtivos || !filtroStatus.mostrarInativos) {
        ...
        // Filtro por dropdown - apenas se não for 'todos'
        ...
        // Operação OU: retorna true se QUALQUER filtro for verdadeiro
        return resultadosFiltros.length > 0 ? resultadosFiltros.some(resultado => resultado) : true;
    });

    return (
        
        <div className="exercicio-container">
            <Header titulo="exercicio7" />
            <h1 className="exercicio-title">👤 CRUD de Usuários com Filtros Combinados (OU)</h1>
            <p className="exercicio-subtitle">
                Sistema completo para gerenciar usuários com filtros avançados usando operação OU - qualquer filtro ativo pode ser verdadeiro
            </p>
