...
export default function Exercicio5() {
    ...
    // Filtrar usuários baseado no termo de busca, intervalo de datas e status
    const usuariosFiltrados = usuarios.filter(usuario => {
        ...
        return nomeOuEmailMatch && dataMatch && statusMatch;
    });

    return (
        
        <div className="exercicio5">
            <Header titulo="exercicio5" />
            <h1 className="exercicio-title">👤 CRUD de Usuários com Filtro Booleano</h1>
            <p className="exercicio-subtitle">
                Sistema completo para gerenciar usuários com filtros avançados incluindo checkbox para status ativo/inativo
            </p>
                ...
                <div className="usuarios-header">
                    ...
                    {usuarios.length > 0 && (
                        <div className="filtros-container">
                            ...
                            {(filtro || filtroDataInicio || filtroDataFim || !filtroStatus.mostrarAtivos || !filtroStatus.mostrarInativos) && (
                                <button
